...
int monitor_single_address_clflush(uintptr_t addr, int print)
{
  ...
  { 
    ...
    {         
      ...
      // Print histogram for each core if not sure of what the threshold values should be
      //#define DEBUG
      #ifdef DEBUG
      for(i = 145; i < 180; ++i)
      {
      ...
      // Based on the historgram, is the address on the same slice as the executing core?
