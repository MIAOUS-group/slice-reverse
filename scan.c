...
int main(int argc, char **argv){
  ...
  if (!strcmp(archi,"sdb")){
    ...
    msr_pmon_ctl0 = (unsigned long long []) {0xe01, 0xe11, 0xe21, 0xe31, 0xe41, 0xe51, 0xe61, 0xe71, 0xe81, 0xe91, 0xea1, 0xeb1, 0xec1, 0xec1, 0xed1, 0xee1, 0xef1, 0xf01, 0xf11};
   ...
   */
   if(nb_cores > max_slices){
     fprintf(stderr,"Specified number of cores (%d) incoherent with maximum number of core of specified micro-architecure (%d for %s). \n", nb_cores, max_slices, archi);
     print_help();
     exit(1);
   }
