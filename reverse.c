...
int main(int argc, char **argv){
  ...
  switch(cpu_model) {
    case 45: case 62: case 63: case 86: case 79: case 85:
      class = "xeon";
      break; 
    case 42: case 58: case 60: case 69: case 70: case 61: case 71: case 78: case 94: case 142: case 158:
      class = "core";
      break;
    default:
      class = "undefined";
  ...
  switch(cpu_model) {
    ...
    case 62: case 58:
      ...
      break; 
    case 63: case 60: case 69: case 70:
      archi = "hsw"; // Haswell
      break; 
    case 86: case 79: case 61: case 71:
      archi = "bdw"; // Broadwell
      break; 
    case 78: case 94:
  ...
  if(!strcmp(class,"xeon")){
    if (!strcmp(archi,"sdb")){
      max_slices = 8;
      msr_pmon_ctr0 = (unsigned long long []) {0xd16, 0xd36, 0xd56, 0xd76, 0xd96, 0xdb6, 0xdd6, 0xdf6};
      msr_pmon_box_filter = (unsigned long long []) {0xd14, 0xd34, 0xd54, 0xd74, 0xd94, 0xdb4, 0xdd4, 0xdf4};
      msr_pmon_ctl0 = (unsigned long long []) {0xd10, 0xd30, 0xd50, 0xd70, 0xd90, 0xdb0, 0xdd0, 0xdf0};
      msr_pmon_box_ctl = (unsigned long long []) {0xd04, 0xd24, 0xd44, 0xd64, 0xd84, 0xda4, 0xdc4, 0xde4};
      ...
      max_slices = 15;
      msr_pmon_ctr0 = (unsigned long long []) {0xd16, 0xd36, 0xd56, 0xd76, 0xd96, 0xdb6, 0xdd6, 0xdf6, 0xe16, 0xe36, 0xe56, 0xe76, 0xe96, 0xeb6, 0xed6};
      msr_pmon_box_filter = (unsigned long long []) {0xd14, 0xd34, 0xd54, 0xd74, 0xd94, 0xdb4, 0xdd4, 0xdf4, 0xe14, 0xe34, 0xe54, 0xe74, 0xe94, 0xeb4, 0xed4};
      msr_pmon_ctl0 = (unsigned long long []) {0xd10, 0xd30, 0xd50, 0xd70, 0xd90, 0xdb0, 0xdd0, 0xdf0, 0xe10, 0xe30, 0xe50, 0xe70, 0xe90, 0xeb0, 0xed0};
      msr_pmon_box_ctl = (unsigned long long []) {0xd04, 0xd24, 0xd44, 0xd64, 0xd84, 0xda4, 0xdc4, 0xde4, 0xe04, 0xe24, 0xe44, 0xe64, 0xe84, 0xea4, 0xec4};
      ...
      max_slices = 18;
      msr_pmon_ctr0 = (unsigned long long []) {0xe08, 0xe18, 0xe28, 0xe38, 0xe48, 0xe58, 0xe68, 0xe78, 0xe88, 0xe98, 0xea8, 0xeb8, 0xec8, 0xed8, 0xee8, 0xef8, 0xf08, 0xf18};
      msr_pmon_box_filter = (unsigned long long []) {0xe05, 0xe15, 0xe25, 0xe35, 0xe45, 0xe55, 0xe65, 0xe75, 0xe85, 0xe95, 0xea5, 0xeb5, 0xec5, 0xed5, 0xee5, 0xef5, 0xf05, 0xf15};
      msr_pmon_ctl0 = (unsigned long long []) {0xe01, 0xe11, 0xe21, 0xe31, 0xe41, 0xe51, 0xe61, 0xe71, 0xe81, 0xe91, 0xea1, 0xeb1, 0xec1, 0xed1, 0xee1, 0xef1, 0xf01, 0xf11};
      msr_pmon_box_ctl = (unsigned long long []) {0xe00, 0xe10, 0xe20, 0xe30, 0xe40, 0xe50, 0xe60, 0xe70, 0xe80, 0xe90, 0xea0, 0xeb0, 0xec0, 0xed0, 0xee0, 0xef0, 0xf00, 0xf10};
      val_box_freeze = 0x30100;
      val_box_reset = 0x30103;
      val_enable_counting = 0x400000;
      val_select_event = 0x401134;
      ...
      max_slices = 24;
      msr_pmon_ctr0 = (unsigned long long []) {0xe08, 0xe18, 0xe28, 0xe38, 0xe48, 0xe58, 0xe68, 0xe78, 0xe88, 0xe98, 0xea8, 0xeb8, 0xec8, 0xed8, 0xee8, 0xef8, 0xf08, 0xf18, 0xf28, 0xf38, 0xf48, 0xf58, 0xf68, 0xf78}; 
      msr_pmon_box_filter = (unsigned long long []) {0xe05, 0xe15, 0xe25, 0xe35, 0xe45, 0xe55, 0xe65, 0xe75, 0xe85, 0xe95, 0xea5, 0xeb5, 0xec5, 0xed5, 0xee5, 0xef5, 0xf05, 0xf15, 0xf25, 0xf35, 0xf45, 0xf55, 0xf65, 0xf75}; 
      msr_pmon_ctl0 = (unsigned long long []) {0xe01, 0xe11, 0xe21, 0xe31, 0xe41, 0xe51, 0xe61, 0xe71, 0xe81, 0xe91, 0xea1, 0xeb1, 0xec1, 0xed1, 0xee1, 0xef1, 0xf01, 0xf11, 0xf21, 0xf31, 0xf41, 0xf51, 0xf61, 0xf71};
      msr_pmon_box_ctl = (unsigned long long []) {0xe00, 0xe10, 0xe20, 0xe30, 0xe40, 0xe50, 0xe60, 0xe70, 0xe80, 0xe90, 0xea0, 0xeb0, 0xec0, 0xed0, 0xee0, 0xef0, 0xf00, 0xf10, 0xf20, 0xf30, 0xf40, 0xf50, 0xf60, 0xf70};
      val_box_freeze = 0x30100;
      val_box_reset = 0x30103;
      val_enable_counting = 0x400000;
      val_select_event = 0x401134;
...
void reverse_core() {
  ...
  char * mem = (char*)mmap(NULL, HUGE_PAGE_SIZE_2M, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS | MAP_POPULATE | MAP_HUGETLB, - 1, 0);
  if (mem == MAP_FAILED) {
  ...
  mem = (char*)mmap(NULL, MMAP_SIZE_CORE, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS | MAP_POPULATE | MAP_HUGETLB, - 1, 0);
  if (mem == MAP_FAILED) {
  ...
  for(k=0; k<bit_max-21+1; k++){
    ...
    for(i=0; i<hugepages_free; i++){
      ...
      paddr1 = (unsigned long long)read_pagemap("/proc/self/pagemap", (uintptr_t)mem + offset1);
      candidate = paddr1 ^ mask;
      for(j=i; j<hugepages_free; j++){
        offset2 = j * 0x200000UL;
        paddr2 = (unsigned long long)read_pagemap("/proc/self/pagemap", (uintptr_t)mem + offset2);
        if(candidate == paddr2){
          is_candidate = 1;
          break;
        }
...
void reverse_xeon() {
  ...
  char * mem = (char*)mmap(NULL, HUGE_PAGE_SIZE, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS | MAP_POPULATE | MAP_HUGETLB, - 1, 0);
  if (mem == MAP_FAILED) {
  ...
  mem = (char*)mmap(NULL, MMAP_SIZE, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS | MAP_POPULATE | MAP_HUGETLB, - 1, 0);
  if (mem == MAP_FAILED) {
    printf("Malloc huge page has failed \n");
    exit(EXIT_FAILURE);
  }
...
void reverse_generic() {
  ...
  for(i=0; i<hugepages_free; i++) {
    ...
    unsigned long long paddr = (unsigned long long)read_pagemap("/proc/self/pagemap", (uintptr_t)mem + offset);
    unsigned long long ppn = (paddr & ~(~0 << (bit_max-21+1)) << 21) >> 21; // keep bits 21 to bit_max+1 from the address
    if(paddr == 0) printf(" %llu", i);
    rev_map[ppn] = i;
  }
